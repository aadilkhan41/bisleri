...
function report(){
    window.location.href = 'https://www.bisleri.com/greener-promise/sustainability-report-2021-22.pdf';
    }

function viewProject1(){
    window.location.href = 'bottles-for-change.html';
    }
function viewProject2(){
    window.location.href = 'rainwater-harvesting.html';
    }
    function jointheinitiative(){
        window.location.href = 'https://www.bottlesforchange.in/home';
        }
            function viewp(){
